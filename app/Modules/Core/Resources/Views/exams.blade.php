                        ...
                        <div class="col-md-10 col-sm-10 col-md-offset-1">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                        <div class="caption">
                                                <i class="fa fa-globe"></i>Register Exam Type
                                        </div>
                                </div>
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <input type="text" id="examname" name="exam" placeholder="exam name" class="form-control input-medium" required="required">
                                                    <br> <br>
                                                </div>
                                            <div class="col-md-6">
                                                    <label>Out of:</label>
                                                    <input type="number" id="outof" name="outof" placeholder="Out of" class="form-control input-medium" required="required" min="0">
                                                    <br> <br>
                                                </div>
                                            <div class="col-md-6" id="newclass">
                                                ...
                                                <div class="col-md-6">
                                                    <br><br>
                                                    <span class="btn blue" id="addexam">Add Exam</span>&nbsp; &nbsp;
                                            ...
                                            <table id="response" class="table table-striped table-bordered table-hover table-full-width">
                                                <tr>
                                                    <th>Exam Id</th><th>Exam Name</th><th>Out of</th><td>Action</td>
                                                </tr>
                                                    @foreach($exams as $exam)
                                                    <tr><td>{{ $exam->id }}</td><td>{{ $exam->name }}</td><td>{{ $exam->outof }}</td><td><a href="{{ url('core/setup/exams/delete') }}/{{ $exam->id }}"><span class="label label-danger label-sm">Delete</span></a></td></tr>
                                                    @endforeach
