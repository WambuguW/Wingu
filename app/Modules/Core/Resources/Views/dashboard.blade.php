...
<head>
<meta charset="utf-8"/>
<title>Wingu Client 1.0 || Dashboard</title>
...
<div class="header navbar navbar-fixed-top">
            ...
            <div class="header-inner">
                <!-- BEGIN LOGO -->
                <a class="navbar-brand" href="{{ URL::to('core/dashboard') }}">
                    <!--<img src="../assets/img/logo.png" alt="Wingu Client 1.0" class="img-responsive"/>-->
                    <img src="{{ asset('assets/img/Wingu.jpg', 'Wingu Client 1.0') }}"/>
                </a>
                <!-- END LOGO -->
            ...
            <div class="col-md-12" style="margin-top: 50px">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <a href="{{ url('core/accounts/users') }}">
                                <div class="dashboard-stat blue">
                                <div class="visual"><i class="fa fa-cogs"></i></div>
                                <div class="details">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <a href="{{ URL::to('core/students/registration') }}">
                                ...
                                <div class="details">
                                    <div class="desc">REGISTRATION</div>
                                </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <a href="{{ URL::to('exams/entry') }}">
                                <div class="dashboard-stat blue">
                                    ...
                                    <div class="details">
                                        <div class="desc">EXAMINATIONS</div>
                                    </div>
                                </div>
                            </a>
                        </div>
...
<script src="{{ asset('assets/scripts/custom/login-soft.js') }}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
