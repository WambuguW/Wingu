                    ...
                    <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="{{ URL::to('core/accounts/roles') }}">
                                        <i class="fa fa-user"></i>
                                        Roles
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('core/accounts/permissions') }}">
                                        <i class="fa fa-user"></i>
                                        Permissions
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('core/accounts/authorization') }}">
                                        <i class="fa fa-user"></i>
                                        Assing Permissions
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('core/accounts/roles/assign') }}">
                                        <i class="fa fa-user"></i>
                                        Assign User Roles
                                    </a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="{{ URL::to('core/students/registration') }}">
                                ...
                                <li>
                                    <a href="{{ URL::to('core/students/details') }}">
                                        <i class="fa fa-list"></i>
                                        Student Details
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('core/students/nextclass') }}">
...
<!--                                ----------------------
                                <li>
                                    <a href="{{ URL::to('core/analysis/genderratio') }}">
                                        <i class="fa fa-signal"></i>
                                        Gender Analysis(Class)
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('core/analysis/schoolgender') }}">
                                        <i class="fa fa-signal"></i>
                ...
                $.ajax(
                        {
                            ...
                            data: {'term': term, 'exam': exam, 'admnum': adm, 'token': token, '_token': $('input[name=_token]').val()},                             
                            cache: false,
                            success: function(data){
                                $('#examresults').empty(); 
                                alert(data);
            ...
            $(document).ready(function(){
                $('#fromclass').change(function (){
                    ...
                    $.ajax(
                            {
                                type: "GET",
                                url: "{{ url('core/students/class/students') }}",
        ...
        <script>
            $(document).ready(function(){
                $('#gender').change(function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('core/students/search/dorm/gender') }}",
        ...
        <script>
            $(document).ready(function(){
               $('#addnewuser').click(function(){
                ...
                if(newuser === '' || email === '' || userrole === '' || userstatus === ''){
                            ...
                            success: function(data){
                                ...
                                $.each(data, function(){
                                    if(this.status === 'Active'){
                                        $('#userstable').append("<tr><td>"+this.id+"</td><td>" + this.username + "</td><td>" + this.email + "</td><td>" + this.status + "</td><td><span class='btn btn-warning btn-xs'>Suspend</span><a href='"+"{{ url('core/accounts/users/delete/" + this.id+"')}}' onclick='return showalert()'><span  class='btn btn-danger btn-xs'>Delete</span></a></td></tr>");
                                    } else{
                                        $('#userstable').append("<tr><td>"+this.id+"</td><td>" + this.username + "</td><td>" + this.email + "</td><td>" + this.status + "</td><td><span class='btn btn-success btn-xs'>Activate</span><a href='"+"{{ url('core/accounts/users/delete/" + this.id+"')}}' onclick='return showalert()'><span  class='btn btn-danger btn-xs'>Delete</span></a></td></tr>");
                                    }                                        
                                    });
                                }
                        });
