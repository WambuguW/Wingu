                        ...
                        <div class="col-md-10 col-sm-10 col-md-offset-1">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                        <div class="caption">
                                                <i class="fa fa-globe"></i>View Results
                                        </div>
                                </div>
                                    ...
                                    <div class="well dark_green">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <select name="class" data-placeholder="Select Class" class="form-control input-medium select2me" required="required" id="class" id="select2_sample4"   >
                                                        <option></option>
                                                        @if(isset($classes))
