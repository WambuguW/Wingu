...
<head>
<meta charset="utf-8"/>
<title>Wingu Client 1.0 || Login</title>
	...
	<!-- BEGIN LOGIN FORM -->
		...
		<div class="alert alert-danger display-hide">
			...
			<span>
                ...
                <!--For successful account creation, notify-->
                    @if(isset($success))
                        <div class="alert alert-success">
                            {{ $success }}
                        </div>
                    @endif
                <!-- Notify a user who tried to access the system without login -->
                    @if(isset($illegal_access))
                        <div class="app-alerts alert alert-danger fade in">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
                            {{ $illegal_access }}
                        </div>
                    @endif
                <!-- If there is a username/password mismatch -->    
